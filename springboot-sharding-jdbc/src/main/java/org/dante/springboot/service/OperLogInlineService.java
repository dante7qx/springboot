...
import org.dante.springboot.repository.OperLogInlineMapper;
...
public class OperLogInlineService {
	...
	public void createTableIfNotExists() {
		operLogMapper.createTableIfNotExists();
	}
	
	public int dropOperLog() {
		return operLogMapper.dropOperLogInline();
	}
