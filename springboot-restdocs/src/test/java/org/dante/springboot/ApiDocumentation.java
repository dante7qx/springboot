...
import org.dante.springboot.dao.NoteDAO;
import org.dante.springboot.dao.TagDAO;
...
public class ApiDocumentation {
	...
	public void indexExample() throws Exception {
		this.mockMvc.perform(get("/"))
			...
			.andDo(document("index-example",
					links(
							linkWithRel("notes").description("The <<resources-notes,NotePOs resource>>"),
							linkWithRel("tags").description("The <<resources-tags,TagPOs resource>>"),
	...
	public void notesListExample() throws Exception {
		...
		createNotePO("REST maturity model",
				"http://martinfowler.com/articles/richardsonMaturityModel.html");
		createNotePO("Hypertext Application Language (HAL)",
				"http://stateless.co/hal_specification.html");
		createNotePO("Application-Level Profile Semantics (ALPS)", "http://alps.io/spec/");
		...
		this.mockMvc.perform(get("/notes"))
			...
			.andDo(document("notes-list-example",
					...
					responseFields(
							subsectionWithPath("_embedded.notes").description("An array of <<resources-note, NotePO resources>>"),
		...
		this.mockMvc.perform(get("/tags"))
			...
			.andDo(document("tags-list-example",
					links(
							...
							linkWithRel("profile").description("The ALPS profile for this resource")),
					responseFields(
							subsectionWithPath("_embedded.tags").description("An array of <<resources-tag,TagPO resources>>"),
							subsectionWithPath("_links").description("<<resources-tags-list-links, Links>> to other resources"))));
	}
	...
	private void createNotePO(String title, String body) {
	...
	private void createTagPO(String name) {
		TagPO tag = new TagPO();
		tag.setName(name);
