...
@Slf4j
public class QuartzAnnotationUtil {
	/** 
     * 通过包名获取包内所有类 
     *  
     * @param pkg 
	...
	public static void main(String[] args) {
		List<SchedulerVO> annotations = QuartzAnnotationUtil.getAnnotation(getClasses("org.dante.springboot.quartz.job"));
		annotations.forEach(a -> log.info("{}", a));
	}
}
